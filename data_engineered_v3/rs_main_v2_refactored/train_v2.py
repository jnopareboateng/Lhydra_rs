...
def main():
    ...
    train_data = pd.read_csv('/home/josh/Lhydra_rs/data_engineered_v3/rs_main_v2_refactored/data/train_data.csv')
    encoders = torch.load('/home/josh/Lhydra_rs/data_engineered_v3/rs_main_v2_refactored/data/data_encoders.pt')
